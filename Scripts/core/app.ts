...
Date: 8/21/2020
Program Description: Creates a scalable, object-oriented application. Rolls dice and displays the total of the dice.
*/
...
(function(){
    ...
    let replayButton: UIObjects.Button;
    ...
    function buildInterface():void
    {
        ...
        replayButton = new UIObjects.Button("replayButton", Config.Screen.CENTER_X + 67, Config.Screen.CENTER_Y + 176, true);
    ...
    function interfaceLogic():void
    {
        ...
        replayButton.on("click", () => {
            console.log("replayButton Button Clicked");
        });
    }
